...
const Footer = () => {
  return (
    <div
      className="mt-40 px-6 py-10 sm:px-20 md:px-24 lg:px-16 xl:px-20"
      style={{ backgroundColor: "#45595b" }}
    >
      <div className="py-10 lg:grid lg:grid-cols-3 lg:items-center xl:flex xl:justify-between ">
        <div>
          <h1
            className="text-3xl font-semibold lg:text-4xl lg:grid-cols-1"
            style={{ color: "#81c408" }}
          >
            Fruitables
          </h1>
          <p className="text-md" style={{ color: "#ffb524" }}>
            Fresh products
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-y-8 lg:grid-cols-4">
        <div>
          ...
          <button
            className="read duration-500 relative py-2 mt-6 right-0 top-0 px-6 border border-orange-400 rounded-full font-semibold text-md"
            type="submit"
          >
            Read More
          </button>
      ...
      <div className="m-auto text-center">
        <p className="font-medium" style={{ color: "#ffffff80" }}>
          <strong style={{ color: "#ffb524" }}>
            &copy;Vegetables Ecommerce,{" "}
          </strong>
          All Right Reserved by Hurair Taqvi
        </p>
      </div>
    </div>
  );
